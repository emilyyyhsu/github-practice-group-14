...
void ADC0_InitSWTriggerSeq3_Ch9(void){ 
  SYSCTL_RCGCGPIO_R |= 0x10;   // 1) activate clock for Port E
	...
	GPIO_PORTD_DIR_R &= ~0x10;      // 2) make PE0 input
  GPIO_PORTD_AFSEL_R |= 0x10;     // 3) enable alternate function on PD0
  GPIO_PORTD_DEN_R &= ~0x10;      // 4) disable digital I/O on PD0
  GPIO_PORTD_AMSEL_R |= 0x10;     // 5) enable analog function on PD0
